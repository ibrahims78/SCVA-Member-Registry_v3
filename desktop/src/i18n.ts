...
const dict = {
  ar: {
    ...
    failSave:             "فشل حفظ",
    pdfNotAvailable:      "خاصيّة تصدير PDF غير متاحة حالياً. يُرجى استخدام تصدير Word كبديل.",
    ...
    restoreInvalidFormat: "صيغة الملف غير صالحة. تأكد أنه ملف نسخة احتياطية صادر من هذا النظام.",
    resetSuccess:         "تم مسح جميع البيانات وإعادة ضبط النظام بنجاح.",
  },
  en: {
    ...
    pdfNotAvailable:      "PDF export is currently unavailable. Please use Word export instead.",
    ...
    restoreInvalidFormat: "Invalid file format. Make sure it is a backup file exported from this system.",
    resetSuccess:         "All data has been cleared and the system has been reset successfully.",
  },
} as const;
